...
the world.  Of these, Athens has the shortest average stop spacing of 595 meters (0.37
miles) and Mexico City has the longest of 1222 meters (0.76 miles)
...
\Sexpr{exp(mean.Distance)} miles. The lognormal distribution was chosen to explicitly

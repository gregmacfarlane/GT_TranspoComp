...
TRB data analysis competition \sep demand modeling \sep trip distribution 
\end{keyword}
\end{frontmatter}
%==============================================================================
...
% Make lognormal distribution graph
\begin{figure}
<<fig_lognormal, fig.keep='last'>>=
x <- seq(0,4,0.01)
y <- dlnorm(x,meanlog=-0.5,sdlog=0.5)
plot(x,y, xlab="Value", ylab="Density")
